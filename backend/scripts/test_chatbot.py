...
chatbot = DocumentQnAChatbot(
    api_key='AIzaSyD0CFf6HByzmgMqQy66hT1ezuGDLllyC4s',
...
# First question
answer1 = chatbot.chat(
    session_id=session_id,
    user_message="What is the main point of this document?"
)
print("Q1:", "What is the main point of this document?")
print("A1:", answer1)
print("\n---\n")

# Follow-up question (referring to previous answer)
answer2 = chatbot.chat(
    session_id=session_id,
    user_message="Can you explain that in simpler terms?"
)
print("Q2:", "Can you explain that in simpler terms?")
print("A2:", answer2)
print("\n---\n")

# Another follow-up (asking for details or examples)
answer3 = chatbot.chat(
    session_id=session_id,
    user_message="Give me an example mentioned in the document."
)
print("Q3:", "Give me an example mentioned in the document.")
print("A3:", answer3)
